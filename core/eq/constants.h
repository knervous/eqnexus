...
constexpr int NUM_EXPANSIONS = EXPANSION_LEVEL_ROF;
...
enum eInventorySlot
{
	...
	InvSlot_LastBagsLot = InvSlot_LastBagSlot,
};
...
inline namespace deprecated {
	constexpr int ITEMITEMTYPE_FOOD = ItemClass_Food;
	constexpr int ITEMITEMTYPE_WATER = ItemClass_Drink;
	constexpr int ITEMITEMTYPE_SCROLL = ItemClass_Spell;
	constexpr int ITEMITEMTYPE_ALCOHOL = ItemClass_Alcohol;
	constexpr int ITEMITEMTYPE_POISON = ItemClass_Poison;
	constexpr int ITEMITEMTYPE_AUGUMENT = ItemClass_Augmentation;
}
...
enum ALTCURRENCY
{
	...
	ALTCURRENCY_FAYCITES  = ALTCURRENCY_FAYCITUM,
	ALTCURRENCY_MCKENZIE  = ALTCURRENCY_MCKENZIESSPECIALBREW,
	ALTCURRENCY_BAYLE  = ALTCURRENCY_BAYLEMARKS,
	ALTCURRENCY_RECLAMATION  = ALTCURRENCY_TOKENSOFRECLAMATION,
	ALTCURRENCY_BRELLIUM  = ALTCURRENCY_BRELLIUMTOKENS,
	ALTCURRENCY_MOTES  = ALTCURRENCY_DREAMMOTES,
	ALTCURRENCY_VOUCHER  = ALTCURRENCY_EXPEDIENTDELIVERYVOUCHERS,
	ALTCURRENCY_COMMEMORATIVE_COINS  = ALTCURRENCY_COMMEMORATIVECOINS,
	ALTCURRENCY_ENERGYCRYSTALS  = ALTCURRENCY_ARXENERGYCRYSTALS,
	ALTCURRENCY_BIFURCATEDCOIN  = ALTCURRENCY_BIFURCATEDCOINS,
	ALTCURRENCY_ADOPTIVE  = ALTCURRENCY_ADOPTIONCOINS,
	ALTCURRENCY_SATHIRSTRADEGEMS  = ALTCURRENCY_SATHIRTRADEGEMS,
	ALTCURRENCY_FETTERREDIFRITCOINS  = ALTCURRENCY_FETTEREDIFRITCOINS,
	ALTCURRENCY_FROSTSTONEDUCAT  = ALTCURRENCY_FROSTSTONEDUCATS,
	ALTCURRENCY_WARLORDSSYMBOL  = ALTCURRENCY_WARLORDSSYMBOLS,
	ALTCURRENCY_OVERSEERTETRADRACHM  = ALTCURRENCY_OVERSEERTETRADRACHMS,
	ALTCURRENCY_RESTLESSMARK  = ALTCURRENCY_RESTLESSMARKS,
	ALTCURRENCY_WARFORGEDEMBLEM  = ALTCURRENCY_WARFORGEDEMBLEMS,
	ALTCURRENCY_SPIRITUALMEDALLION  = ALTCURRENCY_SPIRITUALMEDALLIONS,
};
